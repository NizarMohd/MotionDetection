...
################################################################
# This is a generated script based on design: mlp4002_design
#
...
# source mlp4002_design_script.tcl
...
set design_name mlp4002_design
...
xilinx.com:hls:mlp_myip2:1.0\
xilinx.com:hls:mlp_myip:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: mlp_myip2_0, and set properties
  set mlp_myip2_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mlp_myip2:1.0 mlp_myip2_0 ]

  # Create instance: mlp_myip_0, and set properties
  set mlp_myip_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mlp_myip:1.0 mlp_myip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins mlp_myip_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins mlp_myip2_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net mlp_myip2_0_M_AXIS [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins mlp_myip2_0/M_AXIS]
  connect_bd_intf_net -intf_net mlp_myip_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins mlp_myip_0/M_AXIS]
